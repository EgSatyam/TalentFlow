...
//         {options.map((opt, i) => (
//           <div key={i} className="space-y-2">
//             <div className="group flex items-center gap-4 p-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition">
//               {/* Drag Handle */}
...
//             {/* Conditional nested question */}
//             {opt.conditionalQuestion && (
//               <div className="ml-8 border-l-2 border-gray-300 pl-4 space-y-3 bg-gray-50 rounded-md p-3">
//                 <QuestionCard
//                   question={opt.conditionalQuestion}
//                   updateQuestion={(qid, updates) =>
//                     updateConditional(i, qid, updates)
...
//                   removeQuestion={() => removeConditional(i)}
//                   duplicateQuestion={(q) =>
//                     console.log("Dup nested not implemented", q)
//                   }
//                 />
//               </div>
//             )}
  ...
  return (
    <div className="space-y-6 bg-amber-50 border border-amber-200 rounded-lg p-6 shadow">
      ...
      <div className="space-y-3">
        {options.map((opt, i) => (
          <div key={i} className="space-y-2">
            <div className="group flex items-center gap-4 p-3 bg-amber-100 border border-amber-200 rounded-lg hover:bg-amber-200 transition">
              {/* Drag Handle */}
            ...
            {/* Conditional nested question */}
            {opt.conditionalQuestion && (
              <div className="ml-8 border-l-2 border-emerald-200 pl-4 space-y-3 bg-emerald-50 rounded-md p-3">
                <QuestionCard
                  question={opt.conditionalQuestion}
                  updateQuestion={(qid, updates) => updateConditional(i, qid, updates)}
                  removeQuestion={() => removeConditional(i)}
                  duplicateQuestion={(q) => console.log("Dup nested not implemented", q)}
                />
              </div>
