...
//       {/* File upload preview area */}
//       <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center bg-gray-50 hover:border-indigo-500 hover:bg-indigo-50 transition">
//         <Upload className="w-10 h-10 text-gray-400 mx-auto mb-3" />
//         <p className="text-sm font-medium text-gray-700 mb-1">File upload preview</p>
//         <p className="text-xs text-gray-400">
//           (Upload functionality is for UI preview only)
//         </p>
//       </div>
...
//                 onChange={(e) => updateFileTypeAtIndex(i, e.target.value)}
//                 placeholder="pdf"
//                 className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
//               />
//               <button
//                 onClick={() => removeFileType(i)}
...
//             variant="ghost"
//             onClick={addFileType}
//             className="border border-dashed border-gray-300 hover:border-indigo-500 hover:text-indigo-600 transition"
//           >
//             <FileText className="w-4 h-4 mr-2" />
//             Add File Type
//           </Button>
...
export default function FileUploadQuestion({ question, updateQuestion }) {
  ...
  return (
    <div className="space-y-6 bg-amber-50 border border-amber-200 rounded-lg p-6 shadow">
      {/* File upload preview area */}
      <div className="border-2 border-dashed border-amber-300 rounded-lg p-6 text-center bg-amber-100 hover:border-emerald-500 hover:bg-emerald-50 transition">
        <Upload className="w-10 h-10 text-amber-500 mx-auto mb-3" />
        <p className="text-sm font-medium text-amber-900 mb-1">File upload preview</p>
        <p className="text-xs text-amber-700">(Upload functionality is for UI preview only)</p>
      </div>
      ...
      {fileType === "custom" && (
        <div className="space-y-4">
          ...
          {allowedTypes.map((type, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <input
                ...
                onChange={(e) => updateFileTypeAtIndex(i, e.target.value)}
                placeholder="pdf"
                className="flex-1 border border-amber-300 rounded-md px-3 py-2 text-sm shadow-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
              />
              <button
                onClick={() => removeFileType(i)}
          ...
          <Button
            ...
            variant="ghost"
            onClick={addFileType}
            className="border border-dashed border-amber-300 hover:border-emerald-500 hover:text-emerald-600 transition"
          >
            <FileText className="w-4 h-4 mr-2" />
            Add File Type
          </Button>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-6 mt-2">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-amber-800">Single file</span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="accent-emerald-600"
              />
              <span className="text-sm text-amber-800">Multiple files</span>
            </label>
          </div>
        </div>
      </div>
