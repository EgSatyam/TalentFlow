...
//   if (isSubmitted) {
//     return (
//       <div className="max-w-2xl mx-auto py-16 text-center bg-white shadow-lg rounded-xl">
//         <CheckCircle className="w-20 h-20 text-green-600 mx-auto mb-6" />
//         <h2 className="text-3xl font-extrabold text-gray-800 mb-3">Assessment Submitted!</h2>
//         <p className="text-gray-500 text-lg">Thank you for completing the assessment 🎉</p>
//       </div>
//     );
//   }
...
//           <p className="text-sm text-gray-500 mt-1">
//             Test your assessment while building the form
//           </p>
//         </div>
//       </div>
...
//       <form onSubmit={handleSubmit} className="space-y-6">
//         {sections.map((section) => (
//           <Card key={section.id} className="p-4 border border-gray-200 shadow-sm rounded-lg">
//             <SectionPreview
//               section={section}
//               answers={answers}
//               errors={errors}
...
//             type="submit"
//             size="lg"
//             className="min-w-40 bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-lg shadow-md transition"
//           >
//             Submit Assessment
//           </Button>
//         </div>
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {sections.map((section) => (
          <Card
            key={section.id}
            className="p-6 border border-gray-200 shadow-sm rounded-lg bg-white"
          >
            <SectionPreview
              section={section}
              answers={answers}
