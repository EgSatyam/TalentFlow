...
//   return (
//     <div className={`space-y-4 ${errors[question.id] ? "error-field" : ""}`}>
//       {/* Question Label */}
//       <div className="flex items-center gap-2">
...
//         </label>
//         {question.required && (
//           <span className="text-xs text-red-600 border border-red-300 rounded-md px-2 py-0.5 bg-red-50">
//             Required
//           </span>
//         )}
//       </div>
...
//           onChange={(e) => onChange(question.id, e.target.value, question)}
//           placeholder={question.placeholder || "Enter your answer..."}
//           className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
//         />
//       )}
...
//           placeholder={question.placeholder || "Enter your detailed answer..."}
//           rows={4}
//           className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition resize-y"
//         />
//       )}
...
//           {question.options?.map((opt, idx) => (
//             <div key={idx} className="space-y-2">
//               <label className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-100 cursor-pointer transition">
//                 <input
//                   type="radio"
//                   name={`q-${question.id}`}
//                   value={opt.label}
//                   checked={value === opt.label}
//                   onChange={() => onChange(question.id, opt.label, question)}
...
//             <label
//               key={idx}
//               className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-100 cursor-pointer transition"
//             >
//               <input
//                 type="checkbox"
//                 value={opt}
...
//                   onChange(question.id, newValue, question);
//                 }}
//                 className="accent-indigo-600"
//               />
...
//           <div
//             className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center bg-gray-50 cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition"
//             onClick={() => document.getElementById(`file-input-${question.id}`).click()}
//           >
//             <svg
...
export default function QuestionPreview({ question, answers, errors, onChange }) {
  ...
  return (
    <div className={`space-y-6 bg-white border border-gray-200 rounded-lg p-6 shadow-sm ${errors[question.id] ? "error-field" : ""}`}>
      {/* Question Label */}
      <div className="flex items-center gap-2">
        <label className="block text-base font-semibold text-gray-800">
          {question.question}
